...
gallery: [
  ...
  { src: '/gallery/04-street-nyc-boy-rain.jpeg',      alt: 'NYC street — boy in rain' },
  { src: '/gallery/05-street-nyc-batman.jpeg',        alt: 'Times Square — Batman in the rain' },
  { src: '/gallery/06-couple-under-umbrella.jpeg',    alt: 'Couple under umbrella — NYC rain' },
  { src: '/gallery/07-nyc-rain-bikes-bw.jpeg',        alt: 'NYC cyclists in rain — black & white' },
  { src: '/gallery/08-boston-steam-crossing.jpeg',    alt: 'Boston crosswalk in steam' },
  ...
  { src: '/gallery/11-acadia-lake-friends.jpeg',      alt: 'Acadia — friends at the lake' },
  { src: '/gallery/12-boston-sailor-briefing.jpeg',   alt: 'Sailor briefing on deck' },
],
