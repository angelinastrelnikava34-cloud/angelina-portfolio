...
export const CONTENT = {
  ...
  // ── Featured Work (галерея) ────────────────────────────────────────────────
  gallery: [
    // Твоё новое фото (уже с правильным именем файла)
    {
      src: "/gallery/IMG_8812.jpeg",
...
// — Экспорт по умолчанию (для совместимости со старыми импортами)
